...
* 30 Days of React: learn react programming roadmap
* Backend Developer Roadmap: step-by-step guide to becoming a backend developer
* Boot.Dev: backend development courses with a gamified learning experience
* Codecademy: interactive coding lessons for beginners across many languages
* Codedex.io: gamified coding platform for computer science learning
* Code Ninjas: coding curriculum and challenges for young learners
* CodingBat: code practice exercises for Java and Python
